              ...
              <div className="grid grid-cols-12 gap-8 items-end">
                <div className="col-span-12 md:col-span-7">
                  ...
                  <h1 className="text-[13vw] md:text-[5.8vw] leading-[0.96] tracking-[-0.04em] font-light max-w-5xl text-white">
                    A curated platform for Hawai‘i’s upper-tier property market.
                  </h1>
                </div>

                <div className="col-span-12 md:col-span-3 md:col-start-10">
                  <p className="border-t border-white/18 pt-6 text-[15px] leading-8 text-white/70">
                    Public offerings, private inventory, market reports, editorial features, and selected press connected to Hawai‘i property.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 md:col-span-8 md:col-start-5">
            <h2 className="text-[9vw] md:text-[5.1vw] leading-[0.98] tracking-[-0.04em] font-light max-w-6xl">
              Not every important property is broadly marketed.
            </h2>
            <div className="mt-12 grid md:grid-cols-2 gap-10 max-w-5xl text-[15px] leading-8 text-black/64">
              ...
              <p>
                For many clients, privacy, timing, and controlled visibility are part of the representation itself.
              </p>
            </div>
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="mt-8 flex items-center justify-between border-t border-black/12 pt-6">
            <p className="text-sm text-black/46 max-w-md leading-7">
              The Collection includes public offerings, selected private opportunities, and properties presented through controlled access.
            </p>
          ...
          <div className="col-span-12 md:col-span-5 md:col-start-8">
            <div className="border-t border-white/18 pt-7">
              <p className="text-[16px] leading-8 text-white/68 mb-10">
                The Private Collection allows off-market and privately represented properties to exist within HL1 without broad public exposure. In some cases, only limited information is shown until access is granted.
              </p>
              <div className="grid grid-cols-3 gap-4 text-[10px] uppercase tracking-[0.18em] text-white/48">
                <a href="#" className="border border-white/12 p-5 min-h-24 flex items-end hover:border-white/35 hover:text-white transition">Off-Market</a>
                <a href="#" className="border border-white/12 p-5 min-h-24 flex items-end hover:border-white/35 hover:text-white transition">Coming Soon</a>
                <a href="#" className="border border-white/12 p-5 min-h-24 flex items-end hover:border-white/35 hover:text-white transition">Account Access</a>
              </div>
      ...
      <section className="px-6 md:px-12 py-10 md:py-12 bg-[#f6f1e8] border-y border-black/10">
        <div className="max-w-[1600px] mx-auto grid grid-cols-12 gap-8 items-center">
          ...
          <a href="#intelligence" className="col-span-12 md:col-span-9 group">
            <div className="flex flex-wrap items-center gap-x-10 gap-y-5 text-[12px] md:text-[13px] uppercase tracking-[0.22em] text-black/38 group-hover:text-black/58 transition">
          ...
          <div className="grid grid-cols-12 gap-8 mb-18 md:mb-24">
            ...
            <div className="col-span-12 md:col-span-8 md:col-start-5">
              <h2 className="text-[10vw] md:text-[5.7vw] leading-[0.88] tracking-[-0.075em] font-light max-w-6xl">
                Reporting, commentary, and editorial perspective shaped by the Hawai‘i market.
              </h2>
            </div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-8 items-end mb-16 md:mb-24">
            ...
            <div className="col-span-12 md:col-span-3 md:col-start-10">
              <p className="text-[15px] leading-8 text-white/62 border-t border-white/14 pt-6">
                HL1 Magazine is distributed privately to clients, peers, and select recipients, featuring architecture, design, property, landscape, and editorial perspectives from across the islands.
              </p>
        ...
        <div className="max-w-[1600px] mx-auto grid md:grid-cols-2 border-t border-black/14">
          <article id="rentals" className="py-14 md:py-20 md:pr-16 border-b md:border-b-0 md:border-r border-black/14">
            ...
            <h2 className="text-5xl md:text-[5vw] leading-[0.98] tracking-[-0.04em] font-light max-w-xl">
              Estate stays and property stewardship across the islands.
            </h2>
            <p className="mt-10 text-[15px] leading-8 text-black/62 max-w-lg">
              HL1 Rentals connects clients with a curated selection of residences, estates, and longer-term stays across Hawai‘i, alongside concierge coordination and estate management.
            </p>
          ...
          <article id="representation" className="py-14 md:py-20 md:pl-16">
            ...
            <h2 className="text-5xl md:text-[5vw] leading-[0.98] tracking-[-0.04em] font-light max-w-xl">
              Representation informed by context, discretion, and presentation.
            </h2>
            <p className="mt-10 text-[15px] leading-8 text-black/62 max-w-lg">
              HL1 was created around the belief that significant properties require thoughtful presentation, discretion, and representation grounded in Hawai‘i itself. The platform brings together a small group of Directors whose work reflects that standard throughout the islands.
            </p>
            <a href="#" className="mt-10 inline-flex items-center gap-3 border-b border-black/35 pb-2 text-[10px] uppercase tracking-[0.22em] text-black/60 hover:text-black transition">
